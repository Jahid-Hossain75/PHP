        ...
        <div class="row">
            <div class="col-sm-8 p-2 border border-success mt-5">
                ...
                <?php
                    ...
                    // Select the table and show 5 data
                ...
                <div class="btn_box">
                    <?php
                        ...
                        if($getpageno_decrement == 0){
                            ...
                            echo "<a href='P56 - Pagination Button part-2.php?pageno=$getpageno_decrement'><input type='button' value='<' class='btn btn-success'></a>";
                        }
                        // Serial number page;
                        for($x = 1; $x < $divided; $x++){
                            if($getpageno == $x){
                                echo "<input type='button' value='$x' class='btn btn-info'>";
                            }else{
                                echo "<a href='P56 - Pagination Button part-2.php?pageno=$x'><input type='button' value='$x' class='btn btn-success'></a>";
                            }
                        }
                        // Next page
                        if($getpageno_increment > $divided){
                            ...
                            echo "<a href='P56 - Pagination Button part-2.php?pageno=$getpageno_increment'><input type='button' value='>' class='btn btn-success'></a>";
                        }
                    ?>
                </div>
            </div>
